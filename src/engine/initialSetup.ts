...
export function createInitialPieces(): Piece[] {
  ...
  pieces.push({ id: `p${id++}`, type: 'pawn', color: 'white', file: 5, rank: 3, level: 'W', hasMoved: false });
  ...
  pieces.push({ id: `p${id++}`, type: 'pawn', color: 'white', file: 0, rank: 1, level: 'WKL', hasMoved: false });
  ...
  pieces.push({ id: `p${id++}`, type: 'pawn', color: 'black', file: 5, rank: 6, level: 'B', hasMoved: false });
  ...
  pieces.push({ id: `p${id++}`, type: 'pawn', color: 'black', file: 0, rank: 8, level: 'BKL', hasMoved: false });
